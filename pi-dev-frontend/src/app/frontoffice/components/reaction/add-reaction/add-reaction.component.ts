...
import { Reaction,  } from 'src/app/core/models/Reaction';  // Assure-toi que Reaction et TypeReaction sont définis dans ton module
import { Post } from 'src/app/core/models/Post';
import { TypeReaction } from 'src/app/core/models/TypeReaction'; // Assure-toi que TypeReaction est défini dans ton module
